...
def required(requirements_file):
    ...
    path = os.path.join(BASEDIR, requirements_file)
...
def get_platform_requirements():
    """Retourne le fichier de requirements adapte a la plateforme."""
    system = platform.system()
    mapping = {
        'Linux': 'requirements/requirementslinux.txt',
        'Windows': 'requirements/requirementswindows.txt',
        'Darwin': 'requirements/requirementsmac.txt',
    }
    return mapping.get(system, 'requirements/requirementslinux.txt')
...
setup(
    ...
    install_requires=required(get_platform_requirements()),
    extras_require={
