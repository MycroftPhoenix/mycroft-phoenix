...
def find_plugins(plug_type):
    ...
    """
    # Import paresseux : pkg_resources (setuptools) n'est requis que si on
    # cherche vraiment un plugin externe. Phoenix utilise toujours PiperTTS
    # ou WindowsTTS via TTSFactory.CLASSES, donc ce chemin n'est jamais
    # emprunte en usage normal, et son import ne doit pas bloquer le
    # chargement du module mycroft.tts au complet.
